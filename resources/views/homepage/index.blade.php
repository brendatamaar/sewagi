                        ...
                        <div class="home-search">
                            <div class="input-group input-homepage">
                                ...
                                <input id="homeSearch" type="text"
                                    ...
                                    placeholder="{{ getLocale($locale, 'placeholder-search', 'Enter location, property name, company or education ...') }}"
                                    autocomplete="off">
                                ...
                                <div class="input-group-prepend">
                                    <button type="button"
                                        class="btn btn-primary searchbox-btn">{{ getLocale($locale, 'link-discover', 'Discover') }}</button>
                                </div>
                            </div>
                        </div>
    ...
    <section class="section-content background-aqua py-65">
        ...
        <div class="container">
                    ...
                    <div class="owl-carousel main-listings">
                        <div class="col-12 property-wrapper">
                            <div class="property-item">
                                <div id="" class="pp-images position-relative">
                                    <div id="" class="pp-images position-relative">
                                        <a class="pp-image-content image-wrapper-1" href="/property/1/1" target="_blank">
                                        ...
                                        <a class="pp-image-content image-wrapper-2" href="/property/1/1" target="_blank">
                                        ...
                                        <a class="pp-image-content image-wrapper-3" href="/property/1/1" target="_blank">
                                        ...
                                        <div class="col-md-9 col-12">
                                            <div class="pp-spec d-flex flex-row flex-wrap">
                                                ...
                                                <span
                                                    ...
                                                    <img id="icon-1" src="{{ asset('img/coliving-icon.png') }}"
                                                        alt="icon room">
                                                    <span id="room-1"><span
                                            ...
                                            <div class="pp-highlight">
                                                <div class="pp-tags">
                                                    <span id="tag-right-1" class="card-tag" data-id="1"
                                                        ...
                                                        data-building_size="1" data-unit_size="1">Entire Apartment</span>
                                                ...
                                                <p class="pp-price" data-type="coliving">From <strong><span
                                                            class="starting-price">Rp. 32,800,000 / Month</span></strong>
                                                </p>
                                        ...
                                        <div class="col-md-9 col-12">
                                            <div class="pp-spec d-flex flex-row flex-wrap">
                                                ...
                                                <span
                                                    ...
                                                    <img id="icon-1" src="{{ asset('img/ic_bedroom.png') }}"
                                                        alt="icon bed">
            ...
            <div class="row">
                <div class="col-12 col-lg-10 offset-lg-1">
                    <a href="#"
                        class="btn-more-properties outline-none font-weight-bold">{{ getLocale($locale, 'label-see-more', 'See more') }}
                        <img src="{{ asset('img/long-arrow-right.svg') }}" class="ml-10" alt="long arrow right"></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-12">
                    <p class="font-mono text-uppercase text-color-orange text-center mb-60">
                        {{ getLocale($locale, 'label-we-provide', 'What We Provide') }}</p>
                </div>
            </div>
            <div class="row what-we-provide">
                    ...
                    <div class="we-provide-item mb-lg-0 mb-40">
                        ...
                        <div class="provide-desc text-center">
                            <h5 class="font-size-16">
                                {{ getLocale($locale, 'label-we-provide-1-title', 'Monthly payments') }}</h5>
                            <p class="font-size-14 mb-0">
                                {{ getLocale($locale, 'label-we-provide-1-content', 'Pay as you go') }}.</p>
                        </div>
                    </div>
                </div>
                <!-- end: item -->
                ...
                <div class="col-xl-2-4 col-md-6 col-12">
                    <div class="we-provide-item mb-lg-0 mb-40">
                        ...
                        <div class="provide-desc text-center">
                            <h5 class="font-size-16">{{ getLocale($locale, 'label-we-provide-2-title', 'Flexibility') }}
                            </h5>
                            <p class="font-size-14 mb-0">
                                {{ getLocale($locale, 'label-we-provide-2-content', 'Rent the way you want. Choose your payment and staying terms') }}.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-2-4 col-md-6 col-12">
                    <div class="we-provide-item mb-lg-0 mb-40">
                        ...
                        <div class="provide-desc text-center">
                            <h5 class="font-size-16">
                                {{ getLocale($locale, 'label-we-provide-3-title', 'Preferred locations') }}</h5>
                            <p class="font-size-14 mb-0">
                                {{ getLocale($locale, 'label-we-provide-3-1-content', 'Use our') }} <a
                                    href="javascript:void(0);"
                                    class="font-weight-bold">{{ getLocale($locale, 'label-we-provide-3-2-content', 'commute time') }}</a>
                                {{ getLocale($locale, 'label-we-provide-3-3-content', 'feature to be close to your activity hubs') }}.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-2-4 col-md-6 col-12">
                    <div class="we-provide-item mb-lg-0 mb-40">
                        ...
                        <div class="provide-desc text-center">
                            <h5 class="font-size-16">
                                {{ getLocale($locale, 'label-we-provide-4-title', 'Co-living compatibility') }}</h5>
                            <p class="font-size-14 mb-0">
                                {{ getLocale($locale, 'label-we-provide-4-title', 'We match you with like minded housemates') }}.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-2-4 col-md-6 col-12">
                    <div class="we-provide-item mb-lg-0 mb-40">
                        ...
                        <div class="provide-desc text-center">
                            <h5 class="font-size-16">{{ getLocale($locale, 'label-we-provice-5-title', 'Peace of mind') }}
                            </h5>
                            <p class="font-size-14 mb-0">
                                {{ getLocale($locale, 'label-we-provide-5-content', 'Unified dashboard paired with customer support for a seamless renting experience') }}.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-10">
                        <p class="font-mono title mini text-color-orange text-uppercase mb-24">
                            {{ getLocale($locale, 'label-about-us', 'What is Sewagi') }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 col-md-10">
                        <div>
                            <h3 class="font-size-32 font-weight-bold mb-50">
                                {{ getLocale($locale, 'p-about-us-1', 'SEWAGI lets you rent on your terms & list your property for free') }}.
                            </h3>
                        </div>
                    </div>
                    <div class="col-12 col-md-8 offset-md-3">
                        <div>
                            <p class="font-size-20 mb-15">
                                {{ getLocale($locale, 'p-about-us-2', 'Our marketplace provides you with rental flexibility, proximity & shareability') }}.
                            </p>
                            <p class="font-size-20">
                                {{ getLocale($locale, 'p-about-us-3', 'While giving your property the edge in leasing out faster & safer') }}.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row info-tab-row">
                <div class="col-12">
                    <p class="font-mono title mini text-color-orange text-uppercase mb-24 text-center">
                        {{ getLocale($locale, 'label-how-sewagi-1', 'How Sewagi Helps You as a') }}</p>
                </div>
                <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <p
                                            ...
                                            {{ getLocale($locale, 'label-how-sewagi-2-1-title', 'Find and collect the listings you like') }}
                                        </p>

                                        <p class="mb-15 text-center text-color-gray-1 text-card">
                                            {{ getLocale($locale, 'label-how-sewagi-2-1-content', 'Check out our listing and refine your filters to get the best match') }}.
                                            {{ getLocale($locale, 'label-how-sewagi-4-4-2-content', 'Whenever you see this logo on our listing you may check it out in') }}
                                            <a href="#"
                                                class="font-weight-bold">{{ session('locale') == 'en' ? '360° view' : 'mode 360°' }}</a>
                                        </p>

                                        <div class="tab-footer-icon text-center">
                                            <a href="#" data-toggle="modal"
                                                data-target="#modalExploreLiveVirtualTour"><img
                                                    src="{{ asset('img/ic_360vr_grey.svg') }}" class="icon"></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <div class="mb-15 image-card">
                                        ...
                                        <p
                                            class="mb-15 text-center text-color-dark font-size-20 title-card font-weight-bold">
                                            {{ getLocale($locale, 'label-how-sewagi-2-2-title', 'Schedule for a room tour') }}
                                        </p>
                                        <p class="mb-15 text-center text-color-gray-1 text-card">
                                            {{ getLocale($locale, 'label-how-sewagi-2-2-content', 'Have a closer look at your future home. No strings attached') }}.<br>
                                            {{ getLocale($locale, 'label-how-sewagi-2-2-1-content', 'Whenever you see this logo on our listing, you may schedule a') }}
                                            <a href="#"
                                                class="font-weight-bold">{{ getLocale($locale, 'label-how-sewagi-2-2-2-content', 'Live Virtual Tour') }}</a>
                                        </p>

                                        <div class="tab-footer-icon text-center">
                                            <a href="#" data-toggle="modal"
                                                data-target="#modalExploreLiveVirtualTour"><img
                                                    src="{{ asset('img/ic_view_virtual_field_grey.svg') }}"
                                                    class="icon"></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <p
                                            class="mb-15 text-center text-color-dark font-size-20 title-card font-weight-bold">
                                            {{ getLocale($locale, 'label-how-sewagi-2-3-title', 'Set up your digital identity') }}
                                        </p>
                                        <p class="mb-15 text-center text-color-gray-1 text-card">
                                            {{ getLocale($locale, 'label-how-sewagi-2-3-content', 'Like what you see? Sign the contract digitally and the place is yours') }}
                                        </p>
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <div class="mb-15 image-card">
                                        ...
                                        <p
                                            class="mb-15 text-center text-color-dark font-size-20 title-card font-weight-bold">
                                            <i>{{ getLocale($locale, 'label-how-sewagi-2-4-title', 'MOVE IN!') }}</i>
                                        </p>
                                        <p class="mb-15 text-center text-color-gray-1 text-card">
                                            {{ getLocale($locale, 'label-how-sewagi-2-4-content', 'You are all set! Move in and be part of the community') }}.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container">
                                <div class="row mb-15">
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <p
                                            class="mb-15 text-center text-color-dark font-size-20 title-card font-weight-bold">
                                            {{ getLocale($locale, 'label-how-sewagi-5-1-title', 'Find and collect the listings you like') }}
                                        </p>
                                        <p class="mb-15 text-center text-color-gray-1 text-card">
                                            {{ getLocale($locale, 'label-how-sewagi-5-1-1-content', 'Check out our co-living listing and refine your filters to get the best match') }}.<br>
                                            {{ getLocale($locale, 'label-how-sewagi-5-1-2-content', 'Whenever you see this logo on our listing, you may check it out in') }}
                                            <a href="#"
                                                class="font-weight-bold">{{ session('locale') == 'en' ? '360° view' : 'model 360°' }}</a>
                                        </p>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <p
                                            class="mb-15 text-center text-color-dark font-size-20 title-card font-weight-bold">
                                            {{ getLocale($locale, 'label-how-sewagi-3-2-title', 'Connect with the existing renters') }}
                                        </p>
                                        <p class="mb-15 text-center text-color-gray-1 text-card">
                                            {{ getLocale($locale, 'label-how-sewagi-2-2-content', 'Have a closer look at your future home. No strings attached') }}.
                                            {{ getLocale($locale, 'label-how-sewagi-2-2-1-content', 'Whenever you see this logo on our listing, you may schedule a') }}
                                            <a href="#" target="_blank"
                                                class="font-weight-bold">{{ getLocale($locale, 'label-how-sewagi-2-2-2-content', 'Live Virtual Tour') }}</a>
                                            {{ getLocale($locale, 'label-how-sewagi-2-2-2-content', 'and meet with your potential roommates') }}.
                                        </p>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <p
                                            class="mb-15 text-center text-color-dark font-size-20 title-card font-weight-bold">
                                            {{ getLocale($locale, 'label-how-sewagi-3-3-title', 'Set up your digital identity') }}
                                        </p>
                                        <p class="mb-15 text-center text-color-gray-1 text-card">
                                            {{ getLocale($locale, 'label-how-sewagi-3-3-content', 'Like what you see? Sign the contract digitally and the place is yours') }}.
                                        </p>
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <div class="mb-15 image-card">
                                        ...
                                        <p
                                            class="mb-15 text-center text-color-dark font-size-20 title-card font-weight-bold">
                                            <i>{{ getLocale($locale, 'label-how-sewagi-3-4-title', 'MOVE IN!') }}</i>
                                        </p>
                                        <p class="mb-15 text-center text-color-gray-1 text-card">
                                            {{ getLocale($locale, 'label-how-sewagi-3-4-content', 'You are all set! Move in and be part of the community') }}.
                                        </p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mt-30 text-center">
                                            <button class="btn btn-primary btn-wide" type="button"
                                                class="close font-weight-normal" data-toggle="modal"
                                                data-target="#modalWhatIsColiving">{{ getLocale($locale, 'label-what-is-coliving', 'What is co-living?') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <p
                                            class="mb-15 text-center text-color-dark font-size-20 title-card font-weight-bold">
                                            {{ getLocale($locale, 'label-how-sewagi-4-1-title', 'Tell us about your property') }}
                                        </p>
                                        <p class="mb-15 text-center text-color-gray-1 text-card">
                                            {{ getLocale($locale, 'label-how-sewagi-4-1-content', 'Give us your property details. The more details the better') }}.
                                        </p>
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <div class="mb-15 image-card">
                                        ...
                                        <p
                                            class="mb-15 text-center text-color-dark font-size-20 title-card font-weight-bold">
                                            {{ getLocale($locale, 'label-how-sewagi-4-2-title', 'Let us do the heavy lifting') }}
                                        </p>
                                        <p class="mb-15 text-center text-color-gray-1 text-card">
                                            {{ getLocale($locale, 'label-how-sewagi-4-2-content', 'Sewagi will help you price it right, market it to the right prospects and take care of the paperwork') }}.
                                        </p>
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <div class="mb-15 image-card">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <p
                                            class="mb-15 text-center text-color-dark font-size-20 title-card font-weight-bold">
                                            {{ getLocale($locale, 'label-how-sewagi-4-4-title', 'Get your passive income') }}
                                        </p>
                                        <p class="mb-15 text-center text-color-gray-1 text-card">
                                            {{ getLocale($locale, 'label-how-sewagi-4-4-content', 'Kick back and see your income grow') }}.
                                        </p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mt-30 text-center">
                                            <button class="btn btn-primary btn-wide" type="button"
                                                class="close font-weight-normal" data-toggle="modal"
                                                data-target="#modalPropertyLister">{{ getLocale($locale, 'label-do-it', "Let's do it") }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <h3 class="font-size-32 font-weight-bold text-center mb-40">
                        {{ getLocale($locale, 'label-discover-fit', 'Discover listings that fit you the most') }}</h3>
                </div>
            </div>
            <div class="row row-discover-lists">
                <div class="col-lg-4 col-md-6 col-12 px-0 d-flex align-items-center background-primary-dark">
                    <div class="discover-item co-living">
                        <div class="banner-tag mb-25 background-white">
                            {{ getLocale($locale, 'label-discover-fit-1-1', 'Co-Living') }}</div>
                        <p class="font-size-13 color-white mb-15">
                            {{ getLocale($locale, 'label-discover-fit-1-2', 'Willing to share living space with others?') }}
                        </p>
                        <h4 class="font-size-20 font-weight-bold color-white mb-35">
                            {{ getLocale($locale, 'label-discover-fit-1-3', 'We can help you find the best housemates match') }}.
                        </h4>
                        <a class="btn btn-primary btn-wide btn-block"
                            href="#">{{ getLocale($locale, 'label-discover-fit-1-4', 'Find me a co-living') }}</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12 px-0 d-flex align-items-center background-aqua">
                    <div class="discover-item active-worker">
                        <div class="banner-tag mb-25 background-white">
                            {{ getLocale($locale, 'label-discover-fit-2-1', 'Active Worker') }}</div>
                        <p class="font-size-13 mb-15">
                            {{ getLocale($locale, 'label-discover-fit-2-2', 'Can’t find a living space near your office area?') }}
                        </p>
                        <h4 class="font-size-20 font-weight-bold mb-35">
                            {{ getLocale($locale, 'label-discover-fit-2-3', 'We have listings within walking distance near your office') }}.
                        </h4>
                        <a class="btn btn-primary btn-wide btn-block"
                            href="#">{{ getLocale($locale, 'label-discover-fit-2-4', 'Find a pad near my office') }}</a>
                    </div>
                </div>
                <div class="col-lg-4 col-12 px-0 d-flex align-items-center background-primary-orange">
                    <div class="discover-item family-friendly">
                        <div class="banner-tag mb-25 background-white">
                            {{ getLocale($locale, 'label-discover-fit-3-1', 'Family Friendly') }}</div>
                        <p class="font-size-13 color-white mb-15">
                            {{ getLocale($locale, 'label-discover-fit-3-2', 'Need a living area for your kids?') }}</p>
                        <h4 class="font-size-20 font-weight-bold color-white mb-35">
                            {{ getLocale($locale, 'label-discover-fit-3-3', 'Worry no more. We can provide listings with school nearby') }}.
                        </h4>
                        <a class="btn btn-primary btn-wide btn-block"
                            href="#">{{ getLocale($locale, 'label-discover-fit-3-4', 'Find a pad near school') }}</a>
                ...
                <div class="col-md-6 col-12 d-flex flex-column flex-wrap justify-content-center align-items-center">
                    <div class="property-lister text-center ml-xl-15">
                        <p class="font-mono text-color-orange text-uppercase mb-5">
                            {{ getLocale($locale, 'label-as-role-1', 'Are you a property lister?') }}</p>
                        <h3 class="font-size-32 font-weight-bold color-white mb-40">
                            {{ getLocale($locale, 'label-as-role-2', 'Go for effortless leasing as a') }}</h3>
                        <div class="btn-list-group">
                            <a class="btn btn-primary btn-wide" href="{{ url('/property-lister/homeowner') }}"
                                role="button">{{ getLocale($locale, 'label-as-role-3', 'Homeowner') }}</a>
                            <a class="btn btn-primary btn-wide" href="{{ url('/property-lister/agent') }}"
                                role="button">{{ getLocale($locale, 'label-as-role-4', 'Property Agent') }}</a>
                            <a class="btn btn-primary btn-wide" href="{{ url('/property-lister/building-management') }}"
                                role="button">{{ getLocale($locale, 'label-as-role-5', 'Building Management') }}</a>
                            <a class="btn btn-primary btn-wide" href="{{ url('/property-lister/housemate') }}"
                                role="button">{{ getLocale($locale, 'label-as-role-6', 'Housemate') }}</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section-content">
            <div class="container pt-100 pb-100">
                <div class="row">
                    <div class="col-12">
                        <p
                            class="font-mono font-size-16 font-weight-bold text-color-orange text-uppercase text-center mb-35">
                            {{ getLocale($locale, 'label-testimoni', '') }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-image text-center">
                                            <img class="rounded-circle" src="{{ $review->picture }}"
            ...
            <div class="row">
                <div class="col-12">
                    <div
                        ...
                        <h3 class="font-size-22 font-weight-bold text-center mb-20">Start earning income from real estate
                        ...
                        <a class="btn btn-primary btn-wide" href="{{ url('/join/company-client') }}">Start placing my
                            company staff</a>
                    </div>
                </div>
            </div>
